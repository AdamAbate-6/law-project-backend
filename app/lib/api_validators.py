"""
Query and Path validators used as annotations for arguments to FastAPI REST
methods. FastAPI has built-in functionality for using these to check that 
arguments meet pre-defined specifications.
"""

from fastapi import Query, Path

__user_id_requirements = {
    "max_length": 24,
    "min_length": 24,
    "regex": r"^[a-z0-9]+$",
