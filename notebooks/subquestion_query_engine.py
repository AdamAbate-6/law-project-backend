...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = os.path.join(root_dir, 'law-project-service-account.json')
...
def get_patent_dict(patent_spif):
  ...
  cache_path = pathlib.Path(os.path.join(root_dir, f'law-project-backend\\notebooks\\data\\patents\\{patent_spif}.json'))
